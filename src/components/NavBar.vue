...
export default {
  ...
  methods: {
    ...
    changeLanguage(lang) {
      if (lang !== this.publicStore.language) this.publicStore.setLang(lang);
    },
  ...
  <header>
    ...
    >
      <div class="topbar-item">
        <router-link href="/" to="/" class="logo-box">
          <img
            src="/images/logo-hera-without-text.png"
            alt="Elhira logo"
            class="logo"
          />
          <img
            :src="
              publicStore.language === 'ar'
        ...
        <div class="page-links" v-for="page in pages" :key="page.id">
          <router-link
            ...
            :to="{ path: page.link, replace: true }"
          ...
          <div v-if="page.data" class="dropdown-menu">
            <template v-for="data in page.data" :key="data.id">
              <router-link
                ...
                activeClass="active-inside"
                exactActiveClass="active-inside"
                :to="{ path: data.link, replace: true }"
                >{{ getText(data) }}
              </router-link>
            </template>
          </div>
      ...
      <div class="topbar-op">
        ...
        >
          <div
            ...
            class="language-item"
            :class="
              publicStore.language === lang.name ? 'current-language' : ''
            "
